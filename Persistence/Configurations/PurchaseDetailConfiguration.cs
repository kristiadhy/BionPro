...
internal class PurchaseDetailConfiguration : IEntityTypeConfiguration<PurchaseDetailModel>
{
  public void Configure(EntityTypeBuilder<PurchaseDetailModel> builder)
  {
    ...
    //We forget to set the Purchase Details on the Product model so by default, it is set to cascade delete. So, to prevent this, we set it here to prevent from the cascade delete.
